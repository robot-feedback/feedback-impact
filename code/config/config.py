"""
Configuration file for Feedback Study Application
Contains all constants, file paths, and application settings
"""
...
# OpenAI Settings
OPENAI_MODEL = "gpt-4o-mini"  # For text-based tasks
OPENAI_VISION_MODEL = "gpt-4o-mini"  # For vision tasks (gpt-4o-mini supports vision)

# =============================================================================
# TASK 1 SETTINGS (Pattern Recognition Task)
# =============================================================================
...
TASK_1_AGENT_OPTIONS = ['agent_1', 'agent_2']
TASK_1_SUBJECT_ID_OPTIONS = [f'P_{i}' for i in range(41)]
...
# =============================================================================
# TASK 2 SETTINGS (Text-based Feedback Task)
# =============================================================================

# Task 2 Timer Settings
TIME_PHASE_1 = 240  # 4 minutes in seconds (set to 10 for testing)
TIME_PHASE_2 = 120  # 2 minutes in seconds (set to 10 for testing)
DISPLAY_TIME_1 = "4:00"
DISPLAY_TIME_2 = "2:00"
...
SUBJECT_ID_OPTIONS = [f'P_{i}' for i in range(41)]
